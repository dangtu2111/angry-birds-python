from characters import Boss, Pig
from polygon import Polygon


class Level():
    def __init__(self, pigs, columns, beams, space,pigsBoss):
        self.pigs = pigs
        self.pigsBoss = pigsBoss
    ...
    def build_3(self):
        ...
        self.pigs.append(pig)
        pig = Boss(700,320,self.space)
        self.pigsBoss.append(pig)
